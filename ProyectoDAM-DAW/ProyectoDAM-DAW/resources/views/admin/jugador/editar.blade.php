...
@section('content')
    ...
    <h3>
        ...
        <a href="{{ url("admin/jugadores") }}" title="jugadores">jugadores</a> <span>| </span>
        @if ($row->id)
    ...
    <div class="row">
        ...
        <form class="col m12 l6" method="POST" action="{{ url("admin/jugadores/".$accion) }}">
            @csrf
            <div class="row">
            ...
            <div class="row">
                ...
                <p>
                    <label for="jugadores">
                        <input id="jugadores" name="jugadores" type="checkbox" {{ ($row->jugadores == 1) ? "checked" : "" }}>
                        <span>jugadores</span>
                    </label>
                </p>
                <div class="input-field col s12">
                    <a href="{{ url("admin/jugadores") }}" title="Volver">
