...
@section('content')
    ...
    <h3>
        <a href="{{ route("admin") }}" title="Inicio">Inicio</a> <span>| jugadores</span>
    </h3>
    <div class="row">
        <!--Nuevo-->
                ...
                <div class="card horizontal  sticky-action admin">
                    <div class="card-stacked">
                        <div class="card-content">
                            ...
                            <strong>jugadores: </strong>{{ ($row->jugadores) ? "Sí" : "No" }}<br>
                            <strong>Noticias: </strong>{{ ($row->noticias) ? "Sí" : "No" }}
                        </div>
                        <div class="card-action">
                            <a href="{{ url("admin/jugadores/editar/".$row->id) }}" title="Editar">
                    ...
                    <div class="card-reveal">
                        ...
                        <a href="{{ url("admin/jugadores/borrar/".$row->id) }}" title="Borrar">
